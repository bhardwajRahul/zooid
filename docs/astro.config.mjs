      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Workforce', slug: 'guides/workforce' },
            { label: 'Data References', slug: 'guides/data-refs' },
          ],
        },
        {
          label: 'CLI Reference',
          items: [
            ...
            { label: 'zooid destroy', slug: 'cli/destroy' },
            { label: 'zooid dev', slug: 'cli/dev' },
            { label: 'zooid login', slug: 'cli/login' },
            { label: 'zooid logout', slug: 'cli/logout' },
            { label: 'zooid whoami', slug: 'cli/whoami' },
            { label: 'zooid channel', slug: 'cli/channel' },
            { label: 'zooid role', slug: 'cli/role' },
            { label: 'zooid credentials', slug: 'cli/credentials' },
            ...
            { label: 'zooid pull', slug: 'cli/pull' },
